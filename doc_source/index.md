...
+ [Building serverless applications](serverless-building.md)
   + [Building applications](serverless-sam-cli-using-build.md)
      + [Building Node.js Lambda functions with esbuild (Preview)](serverless-sam-cli-using-build-typescript.md)
...
+ [AWS Cloud Development Kit (CDK)](serverless-cdk.md)
...
+ [AWS SAM Accelerate (Preview)](accelerate.md)
