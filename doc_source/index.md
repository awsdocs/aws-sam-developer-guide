...
+ [Using the AWS Serverless Application Model (AWS SAM)](chapter-using-sam.md)
   + [Using the AWS SAM CLI](using-sam-cli.md)
      ...
      + [Using sam local](using-sam-cli-local.md)
         + [Using sam local generate-event](using-sam-cli-local-generate-event.md)
         + [Using sam local invoke](using-sam-cli-local-invoke.md)
         + [Using sam local start-api](using-sam-cli-local-start-api.md)
         + [Using sam local start-lambda](using-sam-cli-local-start-lambda.md)
...
+ [AWS Serverless Application Model (AWS SAM) specification](sam-specification.md)
   ...
   + [AWS SAM resource and property reference](sam-specification-resources-and-properties.md)
      ...
      + [AWS::Serverless::Connector](sam-resource-connector.md)
         ...
         + [SourceReference](sam-property-connector-sourcereference.md)
      ...
      + [AWS::Serverless::StateMachine](sam-resource-statemachine.md)
         + [EventSource](sam-property-statemachine-statemachineeventsource.md)
            ...
            + [EventBridgeRule](sam-property-statemachine-statemachineeventbridgerule.md)
               ...
               + [Target](sam-property-statemachine-statemachinetarget.md)
            + [Schedule](sam-property-statemachine-statemachineschedule.md)
               ...
               + [Target](sam-property-statemachine-statemachinescheduletarget.md)
   ...
   + [AWS SAM CLI reference](reference-sam-cli.md)
      + [AWS SAM CLI command reference](serverless-sam-cli-command-reference.md)
         ...
         + [sam list](sam-cli-command-reference-sam-list.md)
            + [sam list endpoints](sam-cli-command-reference-sam-list-endpoints.md)
            + [sam list resources](sam-cli-command-reference-sam-list-resources.md)
            + [sam list stack-outputs](sam-cli-command-reference-sam-list-stack-outputs.md)
