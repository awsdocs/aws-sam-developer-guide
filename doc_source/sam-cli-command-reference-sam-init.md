...
| \-r, \-\-runtime \[python3\.9 \| python3\.8 \| python3\.7 \| python3\.6 \| python2\.7 \| ruby2\.7 \| ruby2\.5 \| java11 \| java8 \| dotnetcore3\.1 \| dotnetcore2\.1 \| nodejs14\.x \| nodejs12\.x \| nodejs10\.x \| go1\.x\] |  The Lambda runtime of your application\. This option applies only when the package type is `Zip`\. This parameter is required if `--no-interactive` is specified, `--image-type` is specified as `Zip`, and `--location` is not specified\.  | 
