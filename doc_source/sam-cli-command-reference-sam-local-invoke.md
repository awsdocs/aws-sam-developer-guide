...
| \-n, \-\-env\-vars PATH | The JSON file that contains values for the Lambda function's [environment variables](serverless-sam-cli-using-invoke.md#serverless-sam-cli-using-invoke-environment-file)\. | 
