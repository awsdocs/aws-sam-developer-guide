...
| \-\-resolve\-s3 | Automatically create an Amazon S3 bucket to use for packaging\. If you specify both the \-\-s3\-bucket and \-\-resolve\-s3 options, then an error will result\. | 
